...
\item \textbf{\AEAref}:
  ...
  The student will select you as a writer by using the email address under which you are registered on \AEALink.  When that happens, the AEA will send you an email informing you of the fact.  If you have already set your surrogate, you do not need to do anything (except send the letter to the surrogate).
