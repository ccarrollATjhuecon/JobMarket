...
\begin{document}
\hfill{\tiny \jobname, last reviewed \lastreviewedFAQ} \vspace{.1in}
...
\centerline{\small Last reviewed: \lastreviewedFAQ}\medskip\medskip

% \ifthenelse{\boolean{MyNotes}}{\marginpar{\tiny }}{}


\section*{Deciding whether to go on the market}
...
\item  When do I need to make a decision about whether I am going on
  ...
  \begin{quote}
    ...
    in the program for a 7th year.  (See the graduate \href{https://www.econ2.jhu.edu/pdf/GraduateStudentHandbook_2024-2025.pdf}{handbook} for a fuller discussion of these issues.) 
    ...
    \begin{comment}
      ...
      Our declared public policy (see the graduate \href{handbook}{https://www.econ2.jhu.edu/pdf/Econ_Grad_Handbook.pdf}) is that nobody can enroll for a 7th year
...
\section*{Finding jobs and applying}
...
\section*{References and recommendation letters}
...
\item  Can I send different sets of letters to different employers?
  ...
  \begin{quote}
    ...
    {\JMStaffName}~is prepared to handle different sets of letters to different categories of employers (usually, academic vs nonacademic) but you need to explicitly label those categories for them, and make SURE your letter writers label the letters clearly in the different categories when they send them to the JMStaff.  Like, maybe, letters for academic institutions should have \texttt{academic} in the name of the PDF.
...
\noindent      see
\begin{quote}
    \href{\pageurl/RecLetters}{\texttt{\pageurl/Recletters}}
  \end{quote}
\noindent    for detailed answers
\end{enumerate}

\section*{Your materials}
...
\item  What should be in the abstract?
  \begin{quote}
    The \href{\templatesbloburl/moniker-dir-make/Abstract.tex}{template document} has four elements:
    \begin{itemize}
...
\item  How does the video of the seminar work?
  ...
  \begin{quote}
    ...
    \begin{enumerate}
    	...
    	\item Share the link with the \href{\Notationpage}{JMCC} and \href{\Notationpage}{JMPO} so that they can add it to the JobMarket-KeyDates calendar. The JMPO might want to connect to your talk remotely so it is crucial for you to send them the link.
...
\section*{Interviews and flyouts}
...
\item  What happens during a flyout?
  \begin{quote}
    ...
    with a question or two for them (one could be something about
...
\item Interviews have mostly shifted online since the pandemic. Is it still worth it to go to the ASSA meetings in January?

\begin{quote}
	Check with the current {\JMPO}, since practice continues to move.  The
	standing advice, unchanged since 2023--24, has been:
...
\section*{Money, logistics and special cases}
...
\item  \ifthenelse{\boolean{MyNotes}}{\marginpar{\tiny }}{}  What are the Fed's rules about hiring persons who are not US citizens? 
  ...
  \begin{quote}
    ...
    According to \href{https://www.federalreserve.gov/careers-faqs.htm}{the Board's careers FAQ}, checked 2026-08-11, ``Do you employ noncitizens?  As a general rule, the Board only hires U.S.\ citizens as employees.''  The Board has a strong preference for U.S.\ citizens, and you should plan on that basis.

      \textbf{This is a change.}  Until at least 2017 the same FAQ said the Board would hire any qualified person who was a US citizen \textit{or} who met the requirements of the Immigration Reform and Control Act of 1986, with citizens given preference.  That language is no longer on the page.  If your eligibility to work in the US matters to your job search -- and it will -- do not rely on this paragraph: check the current FAQ yourself, and ask the employer directly.
    ...
    As of the fall of 2017 -- not rechecked since, and the paragraph above shows this area does change -- it was my understanding that the Board and the Banks sponsor people for Green cards after three years of employment.  (This seems to have changed over time, so if it is important to your job choice then you should verify it).
