...
\pagestyle{plain}
\begin{document}
\hfill{\tiny \jobname, last reviewed \lastreviewedSteps} \vspace{0.1in}
...
\item Once your CV, abstract, and job market paper are ready, it will
  ...
  on the job market server (\JHUPublicJMServerhref), under
  \texttt{[YEAR]/}\Moniker, which will be created for you.
  Instructions can be found at the~{\JMPHLink} web page.  For a sense of what
  candidates have posted in the past, see

  \url{https://www.econ2.jhu.edu/jobmarket/2020/}

  \noindent but note that \textbf{the format has since changed}: those pages were
  produced by a departmental process that is no longer in use, so yours will not
  look like them.  Treat them as a guide to \textit{content}, not to appearance or
  to the mechanics of posting.

  \hypertarget{Template}{}
\item Build your own \textbf{personal website}, and send its URL to the {\JMCC}
  by the date in~\timet.  (The department previously built a page for you from a
  \texttt{template.txt} file you filled in on the server; that process is no
  longer in use.  Ask the {\JMPO} how your site gets linked from the
  departmental Job Market Candidates page.)
  Your site should contain only the most essential information
  pertaining to your research, teaching, awards, and references.
  The details are supposed to be in your CV.
  For examples of the \textit{kind} of material to include -- again, in the older
  format, which is no longer how pages are produced -- see:\\
  \indent {\small \url{https://www.econ2.jhu.edu/jobmarket/2012/CareyCM/}}\\
  \indent {\small \url{https://www.econ2.jhu.edu/jobmarket/2007/ThomKE/}}
...
\item \ifdvi\hypertarget{Signal}{\textbf{Signal}~}\fi In November, the AEA job registration process 
  ...
  document).  These signals actually have value because 
  each person has only two of them.

  Think like an economist: You want to send your signals to places where its 
  marginal utility product is highest.

  There are serveral reasons the signal might make a difference at a particular institution.

  The most important one is probably that it increases the institution's perceived probability that, if they make you an offer, you will accept.  Candidates often underestimate the extent to which employers want to avoid making offers to people who will not come.  
  
  Another is that the recruiting committee will look more closely at your application than it will the application of someone with roughly similar qualifications. If there are reasons you are likely to be a particularly ``good fit'' at a particular place, that fact might be missed if the committee did not read your application carefully.

  You are strongly advised to consult with your advisor(s) about where to send the signal. They may have information you do not have about the ``true'' situation at some of the institutions you are considering -- information that could be crucial in making a good choice.
...
\item Prepare for the interviews; several students have provided
  ...
  \begin{quote}
    ...
    \item  Write out your key points as bullet points, and commit them to memory. Be prepared to be interrupted and still be able to recover and return to say the key things you wanted to say.
      ...
      \end{itemize}
    \item  Be confident but not arrogant. Don't look at the floor or ceiling, look at the interviewers. If the interview is by Zoom, you will be sorely tempted to look at the face on your screen when you want to talk to someone.  REMEMBER that the way to look someone in the face is to LOOK AT YOUR CAMERA.  %And be sure not to look only at one of them (even if that one is famous) - that insults the other one.
  ...
  \hypertarget{track-your-interviews}{} % \ifdvi\hypertarget{InterviewPrep}{}\fi
\item (Track Your Interviews)

  See {\Templatesurl} for a link to the template file for keeping track of your interviews.  As with the {\EMW} file, after you copy the {\interviewsMoniker} to your OneDrive folder, you should send a link to your advisors so they can keep track of interviews as they are scheduled.  In addition, you should email your advisors whenever you schedule your first interview, and keep them updated by email as seems appropriate.  (You do not necessarily need to email them about every interview you schedule, but they should feel that you are keeping them reasonably well informed by email).
...
\together{
  \begin{center}
    ...
    \begin{tabular}{rl}
      ...
      \\ Cover Letter & \href{\bloburl/Templates/CreateLabelandCoverLetterInstruction.md}{Templates/CreateLabelandCoverLetterInstruction.md}
      ...
      % \\ Placements & \url{https://www.econ2.jhu.edu/recent_placements}
      % \\ JMCC Help  & \url{https://www.econ2.jhu.edu/jobmarket/Information/}
